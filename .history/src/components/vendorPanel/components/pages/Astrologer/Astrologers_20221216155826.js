    ...
    <>
      ...
      <section>
        ...
        <section
          className={
            popup
              ? "fixed left-0 wcomp bg-[rgb(0,0,0,0.5)] transition-all duration-150 w-full flex justify-center items-center overflow-y-auto  h-screen "
              : "hidden"
          }
          style={{ maxHeight: "100vh" , bottom : '5%' , top : '5%' }}
        >

          ...
          <table className="table-auto  w-full text-left whitespace-no-wrap">
            ...
            <tbody style={{ color: "black" }}>
              {data?.data?.map((i) => (
                ...
                <td className=" py-3 w-36 md:text-base text-sm "> {i.horoScope} </td>
                <td className=" py-3 w-36 md:text-base text-sm "> {i.profession} </td>
                <td className=" py-3 w-36 md:text-base text-sm "> {i.emotion} </td>
                <td className=" py-3 w-36 md:text-base text-sm "> {i.health} </td>
                <td className=" py-3 w-36 md:text-base text-sm "> {i.travel} </td>
